    ...
    <section className="py-16 bg-base-100 text-base-content">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Feature 1 */}
          <div className="bg-base-200 hover:scale-101  p-6 cursor-pointer select-none rounded-2xl shadow-md hover:shadow-xl transition">
          ...
          {/* Feature 4 */}
          <div className=" hover:scale-101 bg-base-200 p-6 cursor-pointer select-none rounded-2xl shadow-md hover:shadow-xl transition">
