...
const AssignmentInfo = () => {
  ...
  const { googleDocsLink, marks, quickNote, email, assignmentId } = assignmentData.data;
  const handleSubmit = (e) => {
    ...
    axios
      ...
      .then(() => {
        ...
        // redirect to PENDING assignment page
  ...
  return (
    <>
      <Helmet>
        <title>Assignment Scoring | PeerSolve</title>
      </Helmet>
      <div className="py-10">
        <form
        ...
        >
          ...
          <div className="form-control col-span-full">
            ...
            <p className="border rounded-xl bg-base-200 border-base-200 p-3 my-2 text-my-gray">
              <a className="link text-sm link-primary" href={googleDocsLink} target="_blank">
                {googleDocsLink}
              </a>
            </p>
          </div>
          <div className="form-control col-span-full">
            ...
            <p className="border rounded-xl bg-base-200 border-base-200 p-3 my-2 select-none text-my-gray">
              {quickNote}
            </p>
          </div>

          <div className=" border-t border-dashed border-my-gray col-span-full">
